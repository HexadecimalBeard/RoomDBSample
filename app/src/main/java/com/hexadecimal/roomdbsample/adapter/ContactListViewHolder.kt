...
class ContactListViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
    LayoutInflater.from(parent.context).inflate(
        (
                // ayaga kaldirilacak xml ve bunu iceren parent i ( ViewGroup) veriyoruz
    ...
    fun bind(
        ...
        onClickListener: (contactInfoEntity: ContactInfoEntity) -> Unit
    ) {

        txtPhoneNumber.text = contactInfoEntity.phoneNumber
        txtContactName.text = contactInfoEntity.contactName
        // age entity class icinde Int olarak tanimlandigi icin toString kullandik
